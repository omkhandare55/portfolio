...
const PROFILES = [
  {
    ...
    desc: 'Top solver ranking with daily active coding streaks',
...
const HIGHLIGHTS = [
  {
    ...
    sub: 'Winner of multiple local and regional hackathons',
    color: '#f59e0b',
  },
  {
    icon: <Award size={18} />,
    text: '2nd Runner-Up at Technovate 2026',
    sub: 'Organized by SVKM, Dhule — Built Debugra editor',
    color: '#fbbf24',
  },
  {
    icon: <TrendingUp size={18} />,
    text: '2500+ Problems Solved',
    sub: 'Across competitive platforms like LeetCode & CodeChef',
    color: '#d97706',
  },
  {
    icon: <Code2 size={18} />,
    text: 'GirlScript SoC Contributor',
    sub: 'Active open-source contributor on GitHub',
    color: '#f59e0b',
  },
];
